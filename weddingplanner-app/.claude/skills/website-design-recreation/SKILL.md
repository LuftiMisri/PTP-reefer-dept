...
description: Recreate a webpage from a reference screenshot using Tailwind CDN, then iteratively screenshot-diff and fix until pixel-accurate.
---
...
When comparing screenshots, be specific about what's wrong. Name the element, the measured value, and the target value. Examples:

- "heading is 32px but reference shows ~24px"
- "gap between cards is 16px but should be 24px"
- "button background is #3B82F6 but reference shows #2563EB"
